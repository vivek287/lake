...
<header class="navbar-fixed-top">
    <div id="mainHeader">
        <div class="container-fluid">
            ...
            <div id="mainMenu" class="collapse navbar-collapse" style="margin-top: 39px !important;margin-left:158px !important;">
                <ul class="nav navbar-nav">
                    <?php
            ...
            <div class="navbar navbar-default">
                <div class="navbar-header">
                    <a class="navbar-brand logo" href="<?php echo DOCBASE.trim(LANG_ALIAS, '/'); ?>" title="<?php echo $homepage['title']; ?>"><img src="<?php echo getFromTemplate('images/logo.png'); ?>" alt="<?php echo SITE_TITLE; ?>"></a>
