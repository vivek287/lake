        ...
        <div class="row mb10">
            ...
            if($result_hotel !== false){
                ...
                foreach($result_hotel as $i => $row){
                    ...
                    $char_limit = 200;
                    $hotel_details = strtrunc(strip_tags($row['descr'], '<br>'), $char_limit, true, '');
                                    ...
                                    <figure class="more-link">
                                        <div class="card-container">
                                            <div class="card">
                                                ...
                                                <div class="front" >  
                                                 <div class="more-content"><h3 itemprop="name" ><?php echo $hotel_title; ?></h3> </div> <div class="img-container lazyload md">
                                                <img class="img-responsive" alt="<?php echo $label; ?>" data-src="<?php echo $thumbpath; ?>" itemprop="photo" width="<?php echo $s[0]; ?>" height="<?php echo $s[1]; ?>">
                                                </div> 
                                                </div>
                                              <div class="back"> 
                                                <div class="more-content"><center><h3 itemprop="name" ><?php echo $hotel_title; ?></h3><p style="color:black;padding-top: 25px;"><?php echo $hotel_details; ?></p></center>  </div></div>
                                            </div>
                                        </div>
                                        <div class="">
                                            <div class="more-icon">
                    ...
                    <div class="clearfix">
                        ...
                        foreach($result_article as $i => $row){
                            ...
                            if(isset($pages[$article_page])){
                                ...
                                <article id="article-<?php echo $article_id; ?>" class="mb20 col-sm-3" itemscope itemtype="http://schema.org/Article">
                                    <div class="row">
                                        <a itemprop="url" href="#" target="<?php echo $target; ?>" class="moreLink">
