...
<header class="navbar-fixed-top" >
    <div id="mainHeader" style="height: 96px;">
        <div class="container-fluid">
            <a class="logo" href="<?php echo DOCBASE.trim(LANG_ALIAS, '/'); ?>" title="<?php echo $homepage['title']; ?>"><img src="<?php echo getFromTemplate('images/logo.png'); ?>" alt="<?php echo SITE_TITLE; ?>" style="padding-left: 60px;
    height: 75px;
    margin-top: 5px;
    /* position: absolute; */
    padding: 10px 60px 0;"></a>
            <div id="secondMenu" style="padding-top: 0px;">
            <div class="right-block-top">
                <ul>
                    <li style="float:left"><a href="tel:<?php echo PHONE; ?>" itemprop="telephone" dir="ltr"><i class="fa fa-phone"></i> <?php echo PHONE; ?></a></li>
                     <?php
                         ...
                         ?>
                            <li class="primary btn-nav">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right" role="menu" style="z-index: 550;">
                                        <?php
            ...
            <div id="mainMenu" class="collapse navbar-collapse" style="margin-top: 10px;
    margin-right: 275px;">
...
<div class="mobile-menu">
    <div id="mySidenav" class="sidenav">
        ...
        <a href="#">CARP FISHING</a>
        <a href="#">MATCH FISHING</a>
        <a href="#">CAT FISHING</a>
        <a href="#">TROUT / SALMON FISHING</a>
        <a href="#">FLY FISHING</a>
        <a href="#">EUROPEAN FISHING</a>
        <a href="#">ALL FISHING</a>
