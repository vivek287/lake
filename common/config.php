<?php
define('SITE_TITLE', 'Lake Exclusive');
...
define('OWNER', 'Lake Exclusive Limited');
define('EMAIL', 'info@lakeexclusive.com');
define('ADDRESS', 'Rowlandson House Room 223, 289-93 Ballards Lane, London, N12 8NP United Kingdom');
define('PHONE', '+44 (0)20 8191 9213');
define('MOBILE', '');
define('FAX', '');
define('DB_NAME', 'lakefinal');
